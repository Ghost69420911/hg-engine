...
.equ TRAINERCLASS_CHAMPION_ALDER,         191
.equ TRAINERCLASS_PKMN_TRAINER_ALAIN,     192
.equ TRAINERCLASS_LEGEND_ASH_KETCHUM,     193
.equ TRAINERCLASS_LEADER_CILAN,           194
.equ TRAINERCLASS_LEADER_CRESS,           195
.equ TRAINERCLASS_LEADER_CHILI,           196
.equ TRAINERCLASS_LEADER_LENORA,          197
.equ TRAINERCLASS_LEADER_BURGH,           198
.equ TRAINERCLASS_LEADER_ELESA,           199
.equ TRAINERCLASS_LEADER_CLAY,            200
.equ TRAINERCLASS_LEADER_SKYLA,           201
.equ TRAINERCLASS_LEADER_BRYCEN,          202
.equ TRAINERCLASS_LEADER_IRIS,            203
.equ TRAINERCLASS_CHAMPION_IRIS,          204
.equ TRAINERCLASS_LEADER_DRAYDEN,         205
.equ TRAINERCLASS_LEADER_MARLON,          206
.equ TRAINERCLASS_ELITE_FOUR_MARSHAL,     207
.equ TRAINERCLASS_ELITE_FOUR_GRIMSLEY,    208
.equ TRAINERCLASS_ELITE_FOUR_SHAUNTAL,    209
.equ TRAINERCLASS_LEADER_ROXIE,           210
.equ TRAINERCLASS_LEADER_CHEREN,          211
.equ TRAINERCLASS_PKMN_TRAINER_CHEREN,    212
.equ TRAINERCLASS_NEO_PLASMA_GHETSIS,     213
.equ TRAINERCLASS_PLASMA_GHETSIS,         214
.equ TRAINERCLASS_PKMN_TRAINER_N,         215
.equ TRAINERCLASS_PKMN_TRAINER_NATE,      216
.equ TRAINERCLASS_UNOVA_LEGEND_HILDA,     217
.equ TRAINERCLASS_UNOVA_LEGEND_HILBERT,   218
.equ TRAINERCLASS_PKMN_TRAINER_ROSA,      219
.equ TRAINERCLASS_PKMN_TRAINER_BIANCA,    220
.equ TRAINERCLASS_PROF_ASSISTANT_BIANCA,  221
.equ TRAINERCLASS_PKMN_TRAINER_BENGA,     222
.equ TRAINERCLASS_EX_ELITE_FOUR_AGATHA,   223
.equ TRAINERCLASS_SHADOW_TRIAD,           224
.equ TRAINERCLASS_NEO_T_PLASMA_GRUNT_F,   225
.equ TRAINERCLASS_TEAM_PLASMA_GRUNT_F,    226
.equ TRAINERCLASS_NEO_T_PLASMA_GRUNT_M,   227
.equ TRAINERCLASS_TEAM_PLASMA_GRUNT_M,    228
.equ TRAINERCLASS_NEO_PLASMA_COLERESS,    229
.equ TRAINERCLASS_EX_NEO_PLASMA_COLERESS, 230
.equ TRAINERCLASS_PKMN_TRAINER_EMMET,     231
.equ TRAINERCLASS_PKMN_TRAINER_INGO,      232
>>>>>>> Stashed changes
