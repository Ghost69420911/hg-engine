...
=======
    ...
    [TRAINERCLASS_PKMN_TRAINER_ALAIN] = TRAINER_MALE,
    [TRAINERCLASS_LEGEND_ASH_KETCHUM] = TRAINER_MALE,
    ...
    [TRAINERCLASS_LEADER_IRIS] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_NEO_PLASMA_GHETSIS] = TRAINER_MALE,
    [TRAINERCLASS_PLASMA_GHETSIS] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_N] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_NATE] = TRAINER_MALE,
    [TRAINERCLASS_UNOVA_LEGEND_HILDA] = TRAINER_FEMALE,
    [TRAINERCLASS_UNOVA_LEGEND_HILBERT] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_ROSA] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_BIANCA] = TRAINER_FEMALE,
    [TRAINERCLASS_PROF_ASSISTANT_BIANCA] = TRAINER_FEMALE,
    [TRAINERCLASS_PKMN_TRAINER_BENGA] = TRAINER_MALE,
    [TRAINERCLASS_EX_ELITE_FOUR_AGATHA] = TRAINER_FEMALE,
    [TRAINERCLASS_SHADOW_TRIAD] = TRAINER_MALE,
    [TRAINERCLASS_NEO_T_PLASMA_GRUNT_F] = TRAINER_FEMALE,
    [TRAINERCLASS_TEAM_PLASMA_GRUNT_F] = TRAINER_FEMALE,
    [TRAINERCLASS_NEO_T_PLASMA_GRUNT_M] = TRAINER_MALE,
    [TRAINERCLASS_TEAM_PLASMA_GRUNT_M] = TRAINER_MALE,
    [TRAINERCLASS_NEO_PLASMA_COLERESS] = TRAINER_MALE,
    [TRAINERCLASS_EX_NEO_PLASMA_COLERESS] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_EMMET] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_INGO] = TRAINER_MALE,
>>>>>>> Stashed changes
};
