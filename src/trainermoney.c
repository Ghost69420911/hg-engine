...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_MYSTERIOUS, .multiplier = 30 },
...
>>>>>>> Stashed changes
	...
	{ .class = TRAINERCLASS_PKMN_TRAINER_YELLOW, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_LEAF, .multiplier = 30 },
...
=======
	...
	{ .class = TRAINERCLASS_PKMN_TRAINER_ALAIN, .multiplier = 30 },
	{ .class = TRAINERCLASS_LEGEND_ASH_KETCHUM, .multiplier = 30 },
	...
	{ .class = TRAINERCLASS_LEADER_IRIS, .multiplier = 30 },
	...
	{ .class = TRAINERCLASS_NEO_PLASMA_GHETSIS, .multiplier = 30 },
	{ .class = TRAINERCLASS_PLASMA_GHETSIS, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_N, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_NATE, .multiplier = 30 },
	{ .class = TRAINERCLASS_UNOVA_LEGEND_HILDA, .multiplier = 30 },
	{ .class = TRAINERCLASS_UNOVA_LEGEND_HILBERT, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_ROSA, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_BIANCA, .multiplier = 30 },
	{ .class = TRAINERCLASS_PROF_ASSISTANT_BIANCA, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_BENGA, .multiplier = 30 },
	{ .class = TRAINERCLASS_EX_ELITE_FOUR_AGATHA, .multiplier = 30 },
	{ .class = TRAINERCLASS_SHADOW_TRIAD, .multiplier = 30 },
	{ .class = TRAINERCLASS_NEO_T_PLASMA_GRUNT_F, .multiplier = 30 },
	{ .class = TRAINERCLASS_TEAM_PLASMA_GRUNT_F, .multiplier = 30 },
	{ .class = TRAINERCLASS_NEO_T_PLASMA_GRUNT_M, .multiplier = 30 },
	{ .class = TRAINERCLASS_TEAM_PLASMA_GRUNT_M, .multiplier = 30 },
	{ .class = TRAINERCLASS_NEO_PLASMA_COLERESS, .multiplier = 30 },
	{ .class = TRAINERCLASS_EX_NEO_PLASMA_COLERESS, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_EMMET, .multiplier = 30 },
	{ .class = TRAINERCLASS_PKMN_TRAINER_INGO, .multiplier = 30 },
>>>>>>> Stashed changes
};
